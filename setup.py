...
setup(name='ADExplorerSnapshot',
      ...
      license='MIT',
      install_requires=['bloodhound-ce @ git+https://github.com/dirkjanm/BloodHound.py@bloodhound-ce','dissect.cstruct>=2.0','frozendict','requests','pwntools>=4.5.0','certipy-ad>=4.4.0'],
      classifiers=[
        'Environment :: Console',
